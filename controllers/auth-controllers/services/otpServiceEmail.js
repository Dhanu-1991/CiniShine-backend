...
export function getOtpEmailContent(otp, purposeInput = 'default') {
  ...
  const purposeMap = {
    ...
    pin_setup: {
      ...
      message: "A request was made to set or update your 4-digit Payment PIN for Wallet One on " + PLATFORM_NAME + ". Use the One-Time Password (OTP) below to authorize this request:",
      badgeColor: "#6366f1",
      headerGradient: "linear-gradient(135deg, #6366f1 0%, #4338ca 100%)",
    },
    wallet_transfer: {
      ...
      message: "A request was initiated to transfer funds from your Settlement Wallet (Wallet 2) to your Primary Wallet (Wallet 1) on " + PLATFORM_NAME + ". Please use the One-Time Password (OTP) below to confirm and authorize this transfer:",
      badgeColor: "#f59e0b",
