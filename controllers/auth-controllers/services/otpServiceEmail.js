...
export function getOtpEmailContent(otp, purposeInput = 'default') {
  ...
  const purposeMap = {
    ...
    adminSignup: {
      ...
      subject: `[${PLATFORM_NAME}] Dedicated Admin Security Code - Application Verification`,
      heading: "Admin Portal Registration",
      message: "An administrative account application request was initiated for your contact. Use the dedicated One-Time Password (OTP) below to authorize and complete your admin registration request:",
      badgeColor: "#4f46e5",
      headerGradient: "linear-gradient(135deg, #4f46e5 0%, #3730a3 100%)",
    },
    admin_signup: {
    ...
    admin_apply: {
      title: "Admin Application Verification",
      subject: `[${PLATFORM_NAME}] Dedicated Admin Security Code - Application Verification`,
      heading: "Admin Application Verification",
      message: "An application for an Admin Account on " + PLATFORM_NAME + " was submitted. Use the dedicated One-Time Password (OTP) below to verify your email and authorize your admin application:",
      badgeColor: "#4f46e5",
      headerGradient: "linear-gradient(135deg, #4f46e5 0%, #3730a3 100%)",
    },
    adminApply: {
    ...
    changePassword: {
      ...
      subject: `[${PLATFORM_NAME}] Password Change Verification Code`,
      heading: "Change Your Password",
      message: "We received a request to change the password for your " + PLATFORM_NAME + " account. Use the One-Time Password (OTP) below to authorize and save this password update:",
      badgeColor: "#4f46e5",
      headerGradient: "linear-gradient(135deg, #4f46e5 0%, #3730a3 100%)",
    },
    change_password: {
    ...
    pin_setup: {
      title: "Payment PIN Security Verification",
      subject: `[${PLATFORM_NAME}] Payment PIN Setup Verification Code`,
      heading: "Set Payment PIN",
      message: "A request was made to set or update your 4-digit Payment PIN for Wallet on " + PLATFORM_NAME + ". Use the One-Time Password (OTP) below to authorize this request:",
      badgeColor: "#6366f1",
      headerGradient: "linear-gradient(135deg, #6366f1 0%, #4338ca 100%)",
    },
    wallet_transfer: {
      title: "Wallet Transfer Authorization",
      subject: `[${PLATFORM_NAME}] Action Required - Wallet Transfer Verification OTP`,
      heading: "Authorize Wallet Transfer",
      message: "A request was initiated to transfer funds from your Payout Balance to your Wallet on " + PLATFORM_NAME + ". Please use the One-Time Password (OTP) below to confirm and authorize this transfer:",
      badgeColor: "#f59e0b",
